    ...
    public function run(): void
    {
        ...
        $rates = [
            ...
            [
                ...
                'image_size' => '512x512',
                'unit_cost_usd' => 0.035,
                'token_conversion_rate' => 3500,
                'is_active' => true,
                'effective_from' => $now,
                'note' => 'Replicate stable-diffusion-3.5-medium 画像生成 (512x512)',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                ...
                'token_conversion_rate' => 400,
                'is_active' => true,
                'effective_from' => $now,
                'note' => 'Replicate animagine-xl-3.1 画像生成 (512x512)',
                'created_at' => $now,
                'updated_at' => $now,
            ],
