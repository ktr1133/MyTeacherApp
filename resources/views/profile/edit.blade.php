        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <main class="flex-1 custom-scrollbar">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12 space-y-6">
                    ...
                    {{-- 二要素認証 --}}
                    <div class="bento-card rounded-2xl shadow-lg overflow-hidden task-card-enter" style="animation-delay: 0.35s;">
                        <div class="px-6 py-4 border-b border-indigo-500/20 dark:border-indigo-500/30 bg-gradient-to-r from-indigo-500/5 to-purple-50/50 dark:from-indigo-500/10 dark:to-purple-900/10">
                            <div class="flex items-center gap-3">
