                        ...
                        <div class="bento-card rounded-2xl shadow-lg p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="span" id="span" required
                                    ...
                                    <option value="{{ config('const.task_spans.short') }}" {{ old('span', $groupTask['span'] ?? 3) == config('const.task_spans.short') ? 'selected' : '' }}>
                                        {{ !$isChildTheme ? '短期' : 'すぐにやる' }}
                                    </option>
                                    <option value="{{ config('const.task_spans.mid') }}" {{ old('span', $groupTask['span'] ?? 3) == config('const.task_spans.mid') ? 'selected' : '' }}>
                                        {{ !$isChildTheme ? '中期' : '今年中' }}
                                    </option>
                                    <option value="{{ config('const.task_spans.long') }}" {{ old('span', $groupTask['span'] ?? 3) == config('const.task_spans.long') ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                {{-- 短期: 日付選択 --}}
                                <div id="due-date-short-container" class="due-date-field {{ $currentSpan == config('const.task_spans.short') ? 'show' : '' }}">
                                    <input type="date" 
                                        id="due_date_short" 
                                        name="due_date"
                                        value="{{ $dueDateShort }}"
                                ...
                                {{-- 中期: 年選択 --}}
                                <div id="due-date-mid-container" class="due-date-field {{ $currentSpan == config('const.task_spans.mid') ? 'show' : '' }}">
                                ...
                                {{-- 長期: テキスト入力 --}}
                                {{-- 長期: テキスト入力 --}}
                                <div id="due-date-long-container" class="due-date-field {{ $currentSpan == config('const.task_spans.long') ? 'show' : '' }}">
                                    <input type="text" 
                                        id="due_date_long"
                                        name="due_date"
                                        value="{{ $dueDateLong }}"
