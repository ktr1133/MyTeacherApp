                    ...
                    <form method="POST" action="{{ route('group-tasks.update', $groupTask['group_task_id'] ?? '') }}" class="space-y-6">
                        ...
                        <div class="bento-card rounded-2xl shadow-lg p-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="due_date" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-1.5">
                            ...
                            {{-- span (hidden) - due_dateから自動計算 --}}
                            <input type="hidden" name="span" value="{{ old('span', $groupTask['span'] ?? 3) }}">
                        </div>
